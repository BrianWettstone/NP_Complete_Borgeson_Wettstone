...
date +"time stamp: %S %N"
echo "test 18 - should be unsatisfiable"
python3 ../exact_solution.py < test18.txt
date +"time stamp: %S %N"
echo "test 19 - should be unsatisfiable"
python3 ../exact_solution.py < test19.txt
date +"time stamp: %S %N"
echo "test 20 - should be unsatisfiable"
python3 ../exact_solution.py < test20.txt
date +"time stamp: %S %N"
echo "test 21 - should be unsatisfiable"
python3 ../exact_solution.py < test21.txt
date +"time stamp: %S %N"
